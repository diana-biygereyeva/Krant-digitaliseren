    ...
    <>
      ...
      <SidebarSlider isOpen={isSidebarOpen} onClose={() => setIsSidebarOpen(false)}>
        <nav className="flex flex-col space-y-4">
         ...
         <a href="/page1" className="hover:underline">Artikel 1</a>
         <a href="/page2" className="hover:underline">Artikel 2</a>
         <a href="/page3" className="hover:underline">Artikel 3</a>
        </nav>
      </SidebarSlider>
    </>
  )
